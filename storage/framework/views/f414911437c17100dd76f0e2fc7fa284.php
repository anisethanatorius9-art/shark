...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => __('Subscription Plans')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Subscription Plans'))]); ?>
    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div class="relative bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-all duration-300 hover:shadow-2xl <?php echo e($index === 1 ? 'ring-2 ring-indigo-500 scale-105 md:scale-110' : ''); ?>">
                    <!-- Popular Badge -->
                    ...
                    <div class="p-8 <?php echo e($index === 1 ? 'pt-12' : ''); ?>">
                        <!-- Plan Icon -->
                        <div class="w-16 h-16 mx-auto mb-6 rounded-2xl flex items-center justify-center
                            <?php echo e($index === 0 ? 'bg-green-100' : ($index === 1 ? 'bg-indigo-100' : 'bg-purple-100')); ?>">
                        ...
                        <!-- Plan Name -->
                        <h2 class="text-2xl font-bold text-gray-900 text-center mb-2"><?php echo e($plan['name']); ?></h2>
                    ...
                    <div class="h-2 bg-gradient-to-r
                        <?php echo e($index === 0 ? 'from-green-500 to-emerald-600' : ($index === 1 ? 'from-indigo-500 to-purple-600' : 'from-purple-500 to-pink-600')); ?>">
                    </div>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\www\shark\resources\views/subscription/pricing.blade.php ENDPATH**/ ?>