    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-3 mb-2">
                <a href="<?php echo e(route('dashboard')); ?>" class="text-blue-600 hover:text-blue-700 text-sm font-medium flex items-center gap-1">
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-2xl border border-gray-200 dark:border-zinc-700 shadow-lg p-8">
            ...
            <div class="mb-8 pb-8 border-b border-gray-200 dark:border-zinc-700">
                <div class="flex items-center justify-between">
                    ...
                    <button
                        ...
                        type="button"
                        class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'relative inline-flex h-8 w-16 items-center rounded-full transition-all duration-200' , 'bg-green-500 hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700'=> $streamingEnabled,
                        'bg-gray-300 hover:bg-gray-400 dark:bg-gray-600 dark:hover:bg-gray-700' => !$streamingEnabled,
                        ]); ?>">
                        <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'inline-flex h-7 w-7 transform rounded-full bg-white transition-transform duration-200 shadow-lg' , 'translate-x-9'=> $streamingEnabled,
            ...
            <!-- Status Indicator -->
            <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'mb-8 p-4 rounded-lg border' , 'bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-700/50'=> $streamingEnabled,
                'bg-gray-50 dark:bg-gray-700/50 border-gray-200 dark:border-gray-600' => !$streamingEnabled,
                ]); ?>">
                <div class="flex items-center gap-3">
                    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'w-3 h-3 rounded-full' , 'bg-green-500 animate-pulse'=> $streamingEnabled,
                        'bg-gray-400' => !$streamingEnabled,
                        ]); ?>"></div>
                    <p class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'text-sm font-medium' , 'text-green-700 dark:text-green-400'=> $streamingEnabled,
                        'text-gray-600 dark:text-gray-400' => !$streamingEnabled,
                        ]); ?>">
                        Streaming is currently <?php echo e($streamingEnabled ? 'ENABLED' : 'DISABLED'); ?>
            ...
            <div class="mb-8 pb-8 border-b border-gray-200 dark:border-zinc-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $availableModels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <button
                        wire:click="updateModel('<?php echo e($key); ?>')"
                        type="button"
                        class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'p-4 rounded-xl border-2 text-left transition-all duration-150 cursor-pointer' , 'border-blue-500 bg-blue-50 dark:bg-blue-900/20 dark:border-blue-400'=> $selectedModel === $key,
                        'border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500' => $selectedModel !== $key,
                        ]); ?>"
                        wire:loading.attr="disabled">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'font-medium' , 'text-blue-600 dark:text-blue-400'=> $selectedModel === $key,
                                    'text-gray-900 dark:text-white' => $selectedModel !== $key,
                                    ]); ?>">
                                    <?php echo e($name); ?>

                                </p>
                                <p class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'text-xs' , 'text-blue-500 dark:text-blue-400'=> $selectedModel === $key,
                                    'text-gray-500 dark:text-gray-400' => $selectedModel !== $key,
                                    ]); ?>">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(strpos($key, 'gpt-4o') !== false): ?>
                                    Fastest & Most Accurate
                                    <?php elseif(strpos($key, 'claude') !== false): ?>
                                    Best for Long Content
                                    <?php elseif(strpos($key, 'llama') !== false): ?>
                                    Open Source Model
                                    <?php else: ?>
                                    Efficient Option
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedModel === $key): ?>
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-4 gap-2 text-center text-sm">
                        <button
                            ...
                            type="button"
                            class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'px-3 py-2 rounded-lg border transition-all duration-150' , 'bg-blue-100 dark:bg-blue-900/20 border-blue-500'=> $chunkDelay === 10,
                        ...
                        <button
                            ...
                            type="button"
                            class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'px-3 py-2 rounded-lg border transition-all duration-150' , 'bg-blue-100 dark:bg-blue-900/20 border-blue-500'=> $chunkDelay === 100,
                        ...
                        <button
                            ...
                            type="button"
                            class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'px-3 py-2 rounded-lg border transition-all duration-150' , 'bg-blue-100 dark:bg-blue-900/20 border-blue-500'=> $chunkDelay === 300,
                        ...
                        <button
                            ...
                            type="button"
                            class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'px-3 py-2 rounded-lg border transition-all duration-150' , 'bg-blue-100 dark:bg-blue-900/20 border-blue-500'=> $chunkDelay === 500,
                    ...
                    <div class="mt-4 p-4 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700/50">
                        <p class="text-sm text-blue-700 dark:text-blue-400 font-medium">
                            Current speed: <span class="font-bold"><?php echo e($chunkDelay); ?>ms</span> per character
                        </p>
            ...
            <div class="flex gap-4">
                <button
                    ...
                    type="button"
                    <?php if(!$streamingEnabled): echo 'disabled'; endif; ?>
                    class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'flex-1 px-6 py-3 rounded-xl transition-all duration-150 font-medium inline-flex items-center justify-center gap-2' , 'bg-blue-600 hover:bg-blue-700 text-white'=> $streamingEnabled,
                ...
                <a href="<?php echo e(route('chats.create')); ?>" class="flex-1 px-6 py-3 rounded-xl bg-green-600 hover:bg-green-700 text-white transition-all font-medium text-center inline-flex items-center justify-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
</div><?php /**PATH C:\www\shark\resources\views/livewire/streaming-settings.blade.php ENDPATH**/ ?>